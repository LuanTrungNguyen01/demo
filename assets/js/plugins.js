! function(e, t) {
    ...
    function Ze(e) {
        if ("undefined" != typeof ShadowRoot) return e instanceof b(e).ShadowRoot || e instanceof ShadowRoot
    }
    var Je = {
        name: "applyStyles",
        enabled: !0,
    ...
    function ct(e) {
        for (var t, i = b(e), s = lt(e); s && (t = s, 0 <= ["table", "td", "th"].indexOf(v(t))) && "static" === _(s).position;) s = lt(s);
    ...
    var ft = {
        ...
        fn: function(e) {
            ...
            a && l && (e = e.padding, i = r, i = pt("number" != typeof(e = "function" == typeof e ? e(Object.assign({}, i.rects, {
                placement: i.placement
            })) : e) ? e : mt(e, Ne)), e = rt(a), n = "y" === c ? k : P, s = "y" === c ? A : M, t = r.rects.reference[d] + r.rects.reference[c] - l[c] - r.rects.popper[d], l = l[c] - r.rects.reference[c], a = (a = ct(a)) ? "y" === c ? a.clientHeight || 0 : a.clientWidth || 0 : 0, n = i[n], i = a - e[d] - i[s], n = ut(n, s = a / 2 - e[d] / 2 + (t / 2 - l / 2), i), r.modifiersData[o] = ((a = {})[c] = n, a.centerOffset = n - s, a))
        },
        effect: function(e) {
            var t = e.state;
    ...
    var xt = {
            ...
            effect: function(e) {
                ...
                return n && a.forEach(function(e) {
                    ...
                    }), r && o.addEventListener("resize", i.update, wt),
                    function() {
    ...
    function Lt(i, e, t, s) {
        var n, r = "clippingParents" === e ? (o = Mt(at(r = i)), w(n = 0 <= ["absolute", "fixed"].indexOf(_(r).position) && x(r) ? ct(r) : r) ? o.filter(function(e) {
    ...
    function $t(e, t) {
        var s, t = t = void 0 === t ? {} : t,
            ...
            t = t.padding,
            t = void 0 === t ? 0 : t,
            t = pt("number" != typeof t ? t : mt(t, Ne)),
            c = e.rects.popper,
        ...
        fn: function(e) {
            var o = e.state,
                ...
                t = Ye.reduce(function(e, t) {
                    var i, s, n, r;
                    return e[t] = (t = t, i = o.rects, s = a, n = L(t), r = 0 <= [P, k].indexOf(n) ? -1 : 1, t = (i = "function" == typeof s ? s(Object.assign({}, i, {
                        placement: t
    ...
    var Xt = Vt({
        defaultModifiers: [xt, Ht, bt, Je, Ft, zt, qt, ft, Nt]
    });
    ...
    class S extends t {
        ...
        _getPlacement() {
            ...
            if (e.classList.contains("dropend")) return si;
            if (e.classList.contains("dropstart")) return ni;
    ...
    class Ai extends t {
        ...
        show(e) {
            this._isShown || this._isTransitioning || y.trigger(this._element, Ti, {
                relatedTarget: e
        ...
        dispose() {
            for (const e of [window, this._dialog]) y.off(e, O);
    ...
    class $ extends t {
        ...
        show(e) {
            this._isShown || y.trigger(this._element, "show.bs.offcanvas", {
                relatedTarget: e
            }).defaultPrevented || (this._isShown = !0, this._backdrop.show(), this._config.scroll || (new ui).hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(Mi), this._queueCallback(() => {
                this._config.scroll && !this._config.backdrop || this._focustrap.activate(), this._element.classList.add("show"), this._element.classList.remove(Mi), y.trigger(this._element, "shown.bs.offcanvas", {
                    relatedTarget: e
                })
            }, this._element, !0))
        }
    ...
    y.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function(e) {
        ...
        for (const e of h.find(Pi)) $.getOrCreateInstance(e).show()
    ...
    class Zi extends t {
        ...
        _getTemplateFactory(e) {
            return this._templateFactory ? this._templateFactory.changeContent(e) : this._templateFactory = new Bi({ ...this._config,
                content: e,
        ...
        _setListeners() {
            var e, t;
            for (const i of this._config.trigger.split(" ")) "click" === i ? y.on(this._element, this.constructor.eventName("click"), this._config.selector, e => {
        ...
        _getConfig(e) {
            ...
            for (const i of Object.keys(t)) Ri.has(i) && delete t[i];
            return e = { ...t,
                ..."object" == typeof e && e ? e : {}
    ...
    class as extends t {
        ...
        _initializeTargetsAndObservables() {
            ...
            for (const t of h.find(ns, this._config.target)) t.hash && !a(t) && (e = h.findOne(t.hash, this._element), s(e) && (this._targetLinks.set(t.hash, t), this._observableSections.set(t.hash, e)))
        }
        _process(e) {
            this._activeTarget !== e && (this._clearActiveClass(this._config.target), (this._activeTarget = e).classList.add(ss), this._activateParents(e), y.trigger(this._element, "activate.bs.scrollspy", {
                relatedTarget: e
            }))
        }
        _activateParents(e) {
            if (e.classList.contains("dropdown-item")) h.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(ss);
            else
                for (const t of h.parents(e, ".nav, .list-group"))
                    for (const i of h.prev(t, ".nav-link, .nav-item > .nav-link, .list-group-item")) i.classList.add(ss)
        }
        _clearActiveClass(e) {
            e.classList.remove(ss);
            for (const t of h.find(ns + "." + ss, e)) t.classList.remove(ss)
        }
        static jQueryInterface(t) {
            return this.each(function() {
    ...
    y.on(window, "load.bs.scrollspy.data-api", () => {
        for (const e of h.find('[data-bs-spy="scroll"]')) as.getOrCreateInstance(e)
    }), e(as);
    const ls = "ArrowRight",
        cs = "ArrowDown",
        z = "active",
    ...
    class hs extends t {
        ...
        _activate(e, t) {
            e && (e.classList.add(z), this._activate(r(e)), this._queueCallback(() => {
                "tab" !== e.getAttribute("role") ? e.classList.add(ds) : (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), y.trigger(e, "shown.bs.tab", {
                    relatedTarget: t
                }))
        ...
        _deactivate(e, t) {
            e && (e.classList.remove(z), e.blur(), this._deactivate(r(e)), this._queueCallback(() => {
                "tab" !== e.getAttribute("role") ? e.classList.remove(ds) : (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), y.trigger(e, "hidden.bs.tab", {
                    relatedTarget: t
                }))
            }, e, e.classList.contains("fade")))
        }
    ...
    y.on(document, "click.bs.tab", ft, function(e) {
        ...
        for (const e of h.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]')) hs.getOrCreateInstance(e)
    }), e(hs);
    const ps = "show",
        ms = "showing",
        fs = {
